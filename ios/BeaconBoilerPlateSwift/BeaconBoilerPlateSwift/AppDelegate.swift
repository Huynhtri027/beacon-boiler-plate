...
class AppDelegate: ATBeaconAppDelegate, UIApplicationDelegate,ATBeaconNotificationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        **/
        initAdtagInstanceWithUrlType(ATUrlTypeDemo ,userLogin: "SDK_0" ,userPassword: "ERv260C3lpbb7N2BuXhI" ,userCompany: "00" ,beaconUuid: "B8DE8D59-EA9A-41E1-870F-9D8A4899E100");
